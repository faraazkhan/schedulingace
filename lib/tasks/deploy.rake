HEROKU_GIT_REMOTES = { production: 'schedulingace', dev: 'schedulingacedev', staging: 'schedulingace' }
DEFAULT_REMOTE     = 'dev'
PING_ENDPOINT      = '/' # A working URL that can be pinged to spin up your dynos
